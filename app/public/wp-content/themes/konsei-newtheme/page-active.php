  ...
  <div class="events-section">
    ...
    <div class="experience-block">
      ...
      <div class="experience-text">
        <h3>地域学習としての体験授業</h3>
        <p>
          伝統工芸に触れながら、ものづくりの楽しさを体験してもらいたいと考えています。<br>
          また、お互いの作品を見せ合い、認め合うことも大切にしています。<br>
          さらに、感想や気づきを作文やお手紙などで表現することで、自分の思いを言葉にする力も育みます。
        </p>
      </div>
    </div>
    ...
    <div class="products-container">
      <div class="product-section">
        ...
        <div class="product-description">
          ...
          <ul>
            <li>一点一点、丁寧に染め上げたオリジナルグラデーション</li>
            <li>鮮やかな色合いで空間を華やかに</li>
            <li>しなやかで強度のある素材を使用、安全・安心</li>
            <li>インテリアにもなる美しさ</li>
            <li>自宅・サロン・スタジオでの使用に最適</li>
          </ul>
        </div>
      </div>
